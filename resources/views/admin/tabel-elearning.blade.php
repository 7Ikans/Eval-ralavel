...
@section('title', 'Tabel E-learning ' . $tahun)

@section('breadcrumb')
    <span>Home</span> / <span>Tabel Evaluasi</span> / <span>E-learning {{ $tahun }}</span>
@endsection

@section('content')
<h3 class="fw-normal mb-4">
    <i class="fa fa-table me-3 text-secondary"></i> Tabel Diklat E-learning {{ $tahun }}
</h3>
